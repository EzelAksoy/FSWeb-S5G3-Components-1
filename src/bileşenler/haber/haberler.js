...
function haberYapici(data) {
  ...
  classP.className = "tarih";
  classP.textContent = data.tarih;
  const yazilar1 = document.createElement("p");
  yazilar1.textContent = data.ilkParagraf;
  const yazilar2 = document.createElement("p");
  yazilar2.textContent = data.ikinciParagraf;
  const yazilar3 = document.createElement("p");
  yazilar3.textContent = data.ucuncuParagraf;
  ...
  article.appendChild(yazilar1);
  article.appendChild(yazilar2);
  article.appendChild(yazilar3);
...
data.forEach((item) => {
  let haber = haberYapici(item);
  document.querySelector(".articles").appendChild(haber);
});
